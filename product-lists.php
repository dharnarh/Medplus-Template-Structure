...
<div class="container-fluid pd">
  <div class="row">
    ...
    <!-- End BAr -->
    <div class="col-lg-12">
      <h1 class="text-body text-center font-secondary mb-5 t-w200"> <span class="font-weight-bold">PRODUCTS</span></h1>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-12 col-md-9">
      <div class="row mobil-h">
        ...
        <div class="col col-xs-4 page-show">
          <h5>Showing 1-9 of 32 results</h5>
        </div>
        <div class="col-md-4">
          <div id="toolbar">
            <span>SORT BY </span>
            <select class="form-control">
              ...
              <option value="all">Highest to Lowest</option>
