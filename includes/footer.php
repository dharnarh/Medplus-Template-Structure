      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 col-2 col order-sm-3 sm-text-center mb-sm-3">
          ...
          <ul class="list-unstyled">
            ...
            <li class="nav-item">
              <a href="\customer-promise.php" class="nav-link pl-0 text-white">Our Customer Promise</a>
            </li>
            <li class="nav-item">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 col-2 col order-sm-4 sm-text-center mb-sm-3">
          ...
          <ul class="list-unstyled">
            <li class="nav-item">
              <a href="\about.php" class="nav-link pl-0 text-white">Company Info</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="\pharmacy.php" class="nav-link pl-0 text-white">Pharmacy Services</a>
            </li>
          </ul>
        </div>
            ...
            <form class="form-inline py-3">
              <div class="input-group mb-2 mr-sm-2">
                <input type="text" type="search"
                  class="form-control form-control-sm bg-transparent border-top-0 border-left-0 border-right-0 rounded-0 mr-3"
                  id="footeremailaddress" placeholder="Email Address">
      ...
      <div class="row small">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-6 col mt-sm-1">
          <a href="http://dmtca.com" target="_blank">
            <p class="text-white sm-text-center text-right link-hover mb-0">Powered By <span
                class="font-weight-bold">DMTCA</span></p>
          </a>
        </div>
      </div>
    </div>
